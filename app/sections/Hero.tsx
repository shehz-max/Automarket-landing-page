      ...
      <div className="hero-grid-split">
        ...
        <div className="hero-left-col">
          <h1 id="hero-heading" className="hero-h1">
            <span className="word"><span className="word-inner">Find</span></span>
            <span className="word"><span className="word-inner">Your</span></span>
            <span className="word accent">
              <span className="word-inner" key={activeCategory}>{activeData.titleAccent}</span>
            </span>
            <span className="word"><span className="word-inner">Car</span></span>
          </h1>
        ...
        <div className="hero-right-col">
          <div className="hero-car-wrapper">
            ...
            <div className="hero-car-image-container">
              ...
              {/* We render all 3 category images statically and crossfade them using CSS opacity */}
              <div className={`hero-car-slide ${activeCategory === "performance" ? "active" : ""}`}>
                <Image
                  src="/car-1.jpg"
                  alt="Performance car template cutout"
                  width={600}
                  height={375}
                  priority
                  quality={90}
              ...
              <div className={`hero-car-slide ${activeCategory === "ev" ? "active" : ""}`}>
                <Image
                  src="/car-5.jpg"
                  alt="Electric car template cutout"
                  width={600}
                  height={375}
                  priority
                  quality={90}
              ...
              <div className={`hero-car-slide ${activeCategory === "suv" ? "active" : ""}`}>
                <Image
                  src="/car-6.jpg"
                  alt="SUV and Offroad car template cutout"
                  width={600}
                  height={375}
                  priority
                  quality={90}
